...
class AppView:
    def __init__(self, root, controller):
        ...
        self.add_word_btn = ttk.Button(self.root, text='Добавить слово')
        self.add_word_btn.pack()
        self.edit_word_btn = ttk.Button(self.root, text='Редактировать слово')
        self.edit_word_btn.pack()
        self.remove_word_btn = ttk.Button(self.root, text='Удалить слово')
        self.remove_word_btn.pack()
        self.add_sentence_btn = ttk.Button(self.root, text='Добавить предложение',
